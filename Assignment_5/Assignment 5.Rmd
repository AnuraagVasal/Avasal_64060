...
#(1) Applying hierarchical clustering to the data using Euclidean distance to the normalize measurements and using Agnes to compare the clustering from single linkage, complete linkage, average linkage, and Ward.
