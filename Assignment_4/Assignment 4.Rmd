...
```
#Data cleaning
a)Justify the various choices made in conducting the cluster analysis,such as weights for different variables, the specific clustering algorithm(s) used, the number of clusters formed, and so on.
...
plot_grid(wss2, sil2)
```
#For Model building, Considering scaled data without omitting Outliers
K = 2
```{r}
